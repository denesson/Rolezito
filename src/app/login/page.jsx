  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#111827]">
      ...
      <main className="flex-grow flex items-center justify-center px-4">
        <form onSubmit={handleLogin} className="max-w-md w-full bg-[#1F2937] border border-[#334155] rounded-xl shadow p-6 space-y-6 text-white">
          ...
          <div className="text-sm text-center space-x-2 text-[#9CA3AF]">
            ...
            <a href="/recuperar-senha" className="underline text-[#0EA5E9] hover:text-[#38BDF8]">Esqueceu sua senha?</a>
          </div>
        </form>
      </main>
      <Footer />

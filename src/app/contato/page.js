...
export default function ContatoPage() {
  ...
  return (
    <>
      ...
      {/* Container principal: toda a altura da tela, fundo escuro e flex-col */}
      <div className="flex flex-col min-h-screen bg-[#111827] text-white">
        
        {/* Main cresce pra ocupar espaço e centraliza o form */}
        ...
        {/* O Footer agora fica “abaixo do main”, sem espaço claro acima */}
        <Footer />
      </div>
    </>
  )
